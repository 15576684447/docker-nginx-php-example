...
?>
    ...
    <div class="v-content">
      ...
      <div class="v-left">
		...
		<div class="widget-container boxed vh-style1">
          <div class="vh-row">
          <button class="toolbarbtn" id="ro_en" type="button" style="margin-left:250px;background-image:url(images/toolbar/live_start.png);background-repeat:no-repeat;" onClick="rtmpbtnClick()"></button>
	  ...
	  <!--
        ...
        <div class="tabs_framed boxed v-righth">
		  ...
		  <!--
            <ul class="tabs clearfix">
              <li>
                <a href="#info" data-toggle="tab">信息</a>              </li>
              <li>
                <a href="#subtitle" data-toggle="tab">字幕</a>
              </li>
              <li>
                <a href="#audio" data-toggle="tab">音量</a>              </li>
              <li class="active">
                <a href="#ptz" data-toggle="tab">云台</a>              </li>
            </ul>
			-->
            <div class="tab-content boxed clearfix v-righttabh">
			<!--
              ...
              <div class="tab-pane fade in active" id="ptz">
                <div class="form-center">
                  ...
                  <div class="ptz_row1">
                    ...
                    <button class="btn_preset" id="prebtn" type="button" style="float: none; margin:0 auto; width:120px;background-color: #5b6267;display:block;" onClick="preBtnClick()">预置位设置</button>
                  	</div>
                  </div>
	   			  <div class=" ptz-pretit">		

                <div style="display: block; height: 290px;" class="ptzpanes" id="pane1">
                    <div id="PresetArea">
    ...
    <div class="v-s6">
      <div class="vh-row6">
        <div class="widget-container boxed vh-col6">
          ...
          <img src="images/vh/control.png" width="24" height="24" id="ptimg0" style="border:1px solid;opacity:0.5" title="云台选择" onClick="ptzctrlImgClick(0)">        </div>
        <div class="widget-container boxed vh-col6">
          <span class="area_tit" id="v2_name">老师近景</span>
          <input type="radio" value="1" id="pt1" name="ptzctrl" style="display:none">
          <img src="images/vh/control.png" width="24" height="24" id="ptimg1" style="border:1px solid;opacity:0.5" title="云台选择" onClick="ptzctrlImgClick(1)">        </div>
        <div class="widget-container boxed vh-col6">
          <span class="area_tit" id="v3_name">老师全景</span>
          <input type="radio" value="2" id="pt2" name="ptzctrl" style="display:none">
          <img src="images/vh/control.png" name="ptimg2" width="24" height="24" id="ptimg2" style="border:1px solid;opacity:0.5" title="云台选择" onClick="ptzctrlImgClick(2)">        </div>
        <div class="widget-container boxed vh-col6">
          <span class="area_tit" id="v4_name">学生近景</span>
          <input type="radio" value="3" id="pt3" name="ptzctrl" style="display:none">
          <img src="images/vh/control.png" width="24" height="24" id="ptimg3" style="border:1px solid;opacity:0.5" title="云台选择" onClick="ptzctrlImgClick(3)">        </div>
        <div class="widget-container boxed vh-col6">
          <span class="area_tit" id="v5_name">学生全景</span>
          <input type="radio" value="4" id="pt4" name="ptzctrl" style="display:none">
          <img src="images/vh/control.png" width="24" height="24" id="ptimg4" style="border:1px solid;opacity:0.5" title="云台选择" onClick="ptzctrlImgClick(4)">        </div>
      </div>
      <div class="clear"></div>
      <div class="widget-container boxed vh-s6">
        ...
        <div class="s6-mid">
          ...
          <img id="ptimg5" onClick="ptzctrlImgClick(5)" src="images/vh/control.png" title="云台选择" style="border:1px solid;opacity:0.5">          </div>
          <div class="widget-container boxed vh-col6">
            <span class="area_tit" id="v7_name">高拍仪</span>
            <input type="radio" value="6" id="pt6" name="ptzctrl" style="display:none">
          <img id="ptimg6" onClick="ptzctrlImgClick(6)" src="images/vh/control.png" title="云台选择" style="border:1px solid;opacity:0.5">          </div>
          <div class="widget-container boxed vh-col6">
            <span class="area_tit" id="v8_name">巡视</span>
            <input type="radio" value="7" id="pt7" name="ptzctrl" style="display:none">
          <img id="ptimg7" onClick="ptzctrlImgClick(7)" src="images/vh/control.png" title="云台选择" style="border:1px solid;opacity:0.5">          </div>
          <div class="widget-container boxed vh-col6">
            <span class="area_tit" id="v9_name">片头</span>          </div>
          <div class="widget-container boxed vh-col6">
            <span class="area_tit" id="v10_name">片尾</span>          </div>
        </div>
        <div class="s6-down">
    ...
    <div class="widget-container boxed vh-style0">
      <div class="inner vh-center">
        <span>Powered By <?php echo constant("CORP"); ?></span>      </div>
    </div>
  </div>
  <!--/ container -->
</div>
...
function playcom(streamurl,streamname)
{
  jwplayer("playwin").setup({
    ...
    file:streamname,
	*/ 
    //streamer: 'rtmp://live.hkstv.hk.lxdns.com/live/hks', 
...
function playsingle(streamurl,streamname)
{
  jwplayer("playw6").setup({
	...
	*/
    ...
    //streamer: 'rtsp://192.168.1.149:8554/vlc', 
	//file: 'player/test.mp4',  
    width:1198,
    height:300
  });
...
function autobtnClick(auto)
{
  ...
  $('#dbauto'+auto).css({"background-color":"#663366"});
...
function recmodeBtnClick(rec)
{
  ...
  $('#recmode'+rec).css({"background-color":"#663366"});
...
//playcom("rtmp://192.168.1.149/live","livestream");
//playsingle("rtmp://192.168.1.149/live","livestream");
</script>
</body>
</html>