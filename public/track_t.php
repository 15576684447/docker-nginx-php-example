        ...
        <div class="v-content">
          <div class="v-left">
            <div class="widget-container boxed vh-style1">
              <div class="vh-row">
                <button class="btn2" type="button" style="width:100px;margin:0 10px 0 10px;" onclick="debugBtnClick(0)">开启调试流</button>
                <button class="btn2" type="button" style="width:100px;margin:0 10px 0 10px;" onclick="playTrackBtnClick()">教师全景</button>
                <button class="btn2" type="button" style="width:100px;margin:0 100px 0 10px;" onclick="playCtrlBtnClick()">教师近景</button>
            ...
            <div class="tabs_framed boxed v-righth">
              <div class="inner">
                <ul class="tabs clearfix">
                  <li class="active"><a href="#initpos" data-toggle="tab">云台初始位置</a></li>
                ...
                <div class="tab-content boxed clearfix v-righth1">
                  <div class="tab-pane fade in active" id="initpos">
                    <div class="form-center v-rightw">
                      ...
                      <div class="form-row">
                        <div class="form-item">
                          <button class="btn2" type="button" style="width:100px;" onclick="saveinitBtnClick()">更新配置</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="areax">
                    <div class="form-center v-rightw">
                        <div class="form-item"><input type="text" style="display:none" id="posxl"></div>
                        <div class="form-item"><input type="text" style="display:none" id="ptzxl"></div>
                        <div class="form-item"><input type="text" style="display:none" id="posxr"></div>
                      <div class="form-row">
                        <div class="form-item"><input type="text" id="ptzxr"></div>
                        <div class="form-label">云台范围：</div>
                      </div>
                      <div class="form-row">
                      ...
                      <div class="form-row">
                        <div class="form-item">
                          <button class="btn2" type="button" style="width:100px;" onclick="saveareaxBtnClick()">更新配置</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
function streamplay2(streamurl,streamname,vw,vh)
{
  ...
  {
    streamplay2("rtmp://"+location.host+"/live","stream1",640,360);
  }

  function ptzOnMouseDown(action)
  {
    ajaxGetData("acttrack.php",4,"1,"+action,HandleNoResult);
  }
  function ptzOnMouseUpPT()
  {
    ajaxGetData("acttrack.php",4,"1,10",HandleNoResult);
  }
  function ptzOnMouseUpZoom()
  {
    ajaxGetData("acttrack.php",4,"1,11",HandleNoResult);
  }
  ...
  {
    ajaxGetData("acttrack.php",5,"1",HandleGetPTZPos);
  }
