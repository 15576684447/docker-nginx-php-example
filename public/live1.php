...
<link href="css/voicebar.css" media="screen" rel="stylesheet">
...
jQuery(document).ready(function() {
  ...
  InitVol();
    ...
    for(var i=0;i<PreSet.length;i++)v1_name
        {
...
{
  jwplayer("playwin").setup({v1_name
...
function HandleRecInfo(){v1_name
  window.rectime++;
  UpdateRecTimeStr();
}
...
function HandleRecResult(rec)
{
  window.leftspace=rec.leftspace;v1_name
  switch(rec.status)
  {
    case "1":
      document.getElementById("recbtn").innerHTML="停止";
...
/*
  ...
  */
  ...
  {
    params+="1";
	document.getElementById("recbtn").value=1;v1_name
